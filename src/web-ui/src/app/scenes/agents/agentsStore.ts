/**
 * Agents scene state management + mock data
 */
...
// ─── Mock agent teams with pre-seeded members ─────────────────────────────────
...
// ─── Agent team templates (for "use template" quick start) ────────────────────
...
// ─── Helper: compute agent team capability coverage ────────────────────────────
...
export type AgentsScenePage = 'home' | 'editor' | 'createAgent';
...
export const useAgentsStore = create<AgentsStoreState>((set) => ({
  ...
  openAgentTeamEditor: (teamId) => set({ page: 'editor', activeAgentTeamId: teamId }),
